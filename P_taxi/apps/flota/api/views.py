...
from App_taxi.api.permissions import (
...
class TipoVehiculoViewSet(
    ...
    def get_permissions(self):
        ...
        if self.action in acciones_administrativas:
            return [
                EsAdminSucursalOSuperAdmin()
            ]
...
class RegistroVehiculoPropioThrottle(
    SimpleRateThrottle
):
...
class RegistrarVehiculoPropioView(
    APIView
):
    permission_classes = [
        IsAuthenticated,
    ...
    throttle_classes = [
        RegistroVehiculoPropioThrottle,
    ]
    ...
    def post(self, request):
        ...
        conductor = (
            vehiculo.propietario_conductor
        )
        ...
        return Response(
            {
                "mensaje": (
                    ...
                    "correctamente y está pendiente "
                    "de aprobación."
                ),
                "vehiculo": {
                    "id": vehiculo.id,
